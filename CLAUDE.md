...
- Proyectos (F13 a F17, **solo planificado, nada implementado**): las notas se agruparán por proyecto, con proyecto activo recordado, búsqueda y orden de proyectos, «Sin proyecto» para las huérfanas y mover notas. Antes de tocar `app/` o `docs/index.html` para esto, leer `docs/planificacion/plan-proyectos.md` (D14 a D26) y las preguntas de su sección 8.
