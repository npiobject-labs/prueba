...
| D77 | **Grabar, pausar y seguir con un solo botón físico, sin mirar la pantalla** (2026-09-25). La sesión de medios se abre ya en «Listo para grabar» (el toque que abre la grabadora sirve de gesto para el audio silencioso) y dura hasta parar o cerrar, también en pausa. `play` y `pause` van al mismo evento `medios`, que decide por el estado: listo → graba, grabando → pausa, en pausa → sigue. Parar sigue siendo en pantalla o en la notificación, para no cortar una entrevista por un toque de más. El WAV silencioso pasa de 1 s a 10 s: Chrome trata lo que dura 5 s o menos como sonido corto y le quita los controles de medios. En el Pixel, el botón es el **doble toque en la trasera** (Ajustes → Sistema → Gestos → Quick Tap → «Reproducir o pausar contenido multimedia»); valen también el botón de unos auriculares o un mando Bluetooth de medios. Volumen y encendido siguen fuera: Chrome en Android no se los pasa nunca a la página. | [SUPUESTO] Quick Tap sigue en el Pixel 10 y manda play/pause a la sesión activa de Chrome. Plan B: auriculares o mando Bluetooth de medios; si ni eso, los botones grandes de la pantalla y la notificación. |
