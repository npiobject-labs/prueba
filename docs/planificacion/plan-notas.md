...
Fecha: 2026-09-20 · Estado: v10, F0 a F10 hechas: notas dictadas, tituladas por IA, buscables, con token, y documentos generados a partir de una selección de notas · Fuente de verdad: este fichero (la copia en Drive es solo copia).
